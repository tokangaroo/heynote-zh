...
export function getEditorContextMenu(win) {
    return Menu.buildFromTemplate([
        ...
        redoMenuItem,
        {type: 'separator'},
        {role: 'cut', label: '剪切' + ACCEL_PAD, accelerator: 'CmdOrCtrl+X'},
        {role: 'copy', label: '复制' + ACCEL_PAD, accelerator: 'CmdOrCtrl+C'},
        {role: 'paste', label: '粘贴' + ACCEL_PAD, accelerator: 'CmdOrCtrl+V'},
        {type: 'separator'},
        selectAllMenuItem,
        {type: 'separator'},
        deleteBlockMenuItem,
